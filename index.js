...
<div class="ad-text" id="ad-text">My Other Codes<button class="close-btn" onclick="closeAd()">close</button></div>
...
const doublyLikedList = () => {
    ...
    <div class="list-container" id="lstcnt">
        ...
        <div id="warning">Activities ...</div>
            ...
            <div class="ad-section" id="ad-section">
                <button class="ad-btns" onclick="gotoSite('https://code.sololearn.com/W1A4a6a25A5a')">Code Store</button>
                <button class="ad-btns" onclick="gotoSite('https://code.sololearn.com/Wa132A235A18')">Google Form</button>
                <button class="ad-btns" onclick="gotoSite('https://code.sololearn.com/W4a10A9a06a8')">Number</button>
            </div>
    `;
}
...
const circularLikedList = () => {
    ...
    <div class="list-container" id="lstcnt">
        ...
        <div class="ad-text" id="ad-text">My Other Codes<button class="close-btn" onclick="closeAd()">close</button></div>
                    ...
                    <div class="ad-section" id="ad-section">
                        <button class="ad-btns" onclick="gotoSite('https://code.sololearn.com/W1A4a6a25A5a')">Code Store</button>
                        <button class="ad-btns" onclick="gotoSite('https://code.sololearn.com/Wa19a9a238A2')">Matrix</button>
                        <button class="ad-btns" onclick="gotoSite('https://code.sololearn.com/WkP7ioQWOUPz')">Notepad</button>
                    </div>
    `;
}
